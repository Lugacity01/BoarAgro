...
export default function HeroSection() {
  return (
    <motion.section
      initial="hidden"
      animate="visible"
      className="relative min-h-170 lg:min-h-screen flex overflow-hidden"
    >
      {/* Background */}
      ...
      >
        <div className="container mx-auto px-4 md:px-6 lg:p-10 xl:px-20 text-white pb-16 lg:pb-0">
          ...
          <div className="lg:grid lg:grid-cols-12 items-center gap-6">
            ...
            >
              From our farms and partners in Nigeria to processors across Europe
              and Asia, BOAR Agro connects high-quality agricultural produce to
              global markets through a transparent, technology-driven, and
              sustainability-anchored value chain.
            </motion.p>
